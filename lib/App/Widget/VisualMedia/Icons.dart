...
class CupertinoIcons {
  ...
  static const IconData clear_circled = IconData(0xf405,
      fontFamily: 'CupertinoIcons', fontPackage: 'cupertino_icons');
  static const IconData search = IconData(0xf40d,
      fontFamily: 'CupertinoIcons', fontPackage: 'cupertino_icons');
...
class MaterialIcons {
  static const IconData person = Icons.person; // Ícono de persona para Información de la cuenta
  ...
  static const IconData delete = Icons.delete; // Ícono de papelera para Eliminar elementos
