...
import 'package:escuchamos_flutter/App/Widget/CustomInput8.dart'; 
...
void _onConfirmCode() async {
  ...
  showDialog(
    ...
    // Navegar a la ruta de recover-account-Change-Password después de cerrar el diálogo
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            CustomInput8(
              text: 'Ingrese código', // Puedes personalizar el texto que aparece como placeholder
              input: _codeController, // Aquí debes definir el controlador en tu otra vista
            ),
